...
int coloram = 6; //IMPORTANT Amount of colors you want in your result
...
int palsw = 4; //paletteswitch, 0 is random, 1 is random+black, 2 is 3bit and anything else is b&w monochrome
int loops = 12; //amount of loops for randomcolor.
String image = "woot2.png"; //path to image
